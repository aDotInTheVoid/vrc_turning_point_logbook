...
\begin{figure}[h] \centering 
	...
	\includegraphics[height=265pt,width=\linewidth,keepaspectratio]{drivetrains/tankAllOmni} \caption{A typical tank drive with all omni-wheels} \label{fig:drivetrainTankAllOmni} \end{figure} 
...
\begin{figure}[h] \centering 
	...
	\includegraphics[height=265pt,width=\linewidth,keepaspectratio]{drivetrains/tankAllTraction} \caption{A typical tank drive with all traction wheels} \label{fig:drivetrainTankAllTraction} \end{figure} 
